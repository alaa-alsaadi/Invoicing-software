    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                <form action={{ route('inovice.store') }} method="POST" class="form">
                @csrf
                <div class="row">
                    <div class="col-4">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <td>
                                        <div class="input-group mb-3">
                                            <select name="discount_type" id="discount_type" class="discount_type custom-select">
                                                <option value="fixed">{{ __('Frontend/frontend.iqd') }}</option>
                        ...
                        <div class="text-right pt-3">
                            <button type="submit" name="save" class="btn btn-success">{{ __('Frontend/frontend.save') }}</button>
                        </div>
                </form>
            </div>
        </div>
...
@section('script')
    ...
    @if(config('app.locale') == 'ar')
        < src="{{ asset('frontend/js/form_validation/messages_ar.js') }}"></>
    @endif
...
<script>
    ...
    $(document).on('click', '.btn_add', function () {
        ...
        $('#invoice_details').find('tbody').append($('' +
            ...
            '<td><button type="button" class="btn btn-danger btn-sm delegated-btn"><i class="fa fa-times"></i></button></td>' +
